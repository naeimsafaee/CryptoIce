...
class ClientCoinController extends \TCG\Voyager\Http\Controllers\Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $dataTypeContent = $dataTypeContent->groupBy('client_id');
        ...
        if (view()->exists("voyager::$slug.browse")) {
            $view = "voyager::$slug.grouped";
        }

        $dataTypeContent1 = $dataTypeContent;
    ...
    public function show(Request $request, $id)
    {
        ...
        $dataTypeContent = ClientCoin::query()->where('client_id' , $id)->orderByDesc('amount')->get();
