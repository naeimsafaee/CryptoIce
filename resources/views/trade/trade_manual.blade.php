                                ...
                                <div class="col-lg-7 col-md-12 col-sm-12 col-12">
                                    <div class="row">
                                        <div class=" col-lg-12 col-md-12 col-sm-12 col-12">
                                            <form class="form sell-form" action="{{ route('submit_buy_trade') }}" method="POST">
                                                @csrf
                                                ...
                                                <div class="row">
                                                                    ...
                                                                    <ul>
                                                                        @foreach(\App\Models\CoinPrice::all() as $coin_price1)
                                                                            <li class="select_coin"
                                                                                data-id="{{ $coin_price1->id }}" data-price="{{ $coin_price1->price }}" data-symbol="{{ strtoupper($coin_price1->coin->symbol) }}">
                                                                                <a>
                                                                                    <span
                                                    ...
                                                    <div class="padding-items col-lg-12 col-md-12 col-sm-12">
                                                        ...
                                                        <h6 class="price margin">
                                                            Min amount: <span>${{ $coin_price->min_deposit }}</span>
                                                        </h6>
                                                    </div>
                                                    <div class=" padding-items col-lg-12 col-md-12 col-sm-12">
                                                        <h6 class="price margin">
