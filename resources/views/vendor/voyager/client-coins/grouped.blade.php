    ...
    <div class="bread">
        ...
        <div class="table-responsive">
            <table id="dataTable" class="table">
                ...
                <tbody>
                @foreach($dataTypeContent1 as $dataTypeContent)
                        ...
                        <tr>
                            ...
                            <td class="no-sort no-click" id="bread-actions">
                                {{--@foreach($actions as $action)
                                    ...
                                    @endif
                                @endforeach--}}
                                <a href="{{ route('voyager.client-coins.show' , $data->client_id) }}" title="View" class="btn btn-sm btn-warning pull-right view">
