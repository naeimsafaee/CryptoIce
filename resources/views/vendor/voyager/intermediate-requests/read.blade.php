...
@section('page_header')
    <div class="action">
        ...
        <a class="btn btn-red btn-danger " href="{{ route('show_decrease_client_status1' , $dataTypeContent->id) }}">
            <span><i class="voyager-exclamation"></i></span>&nbsp;
            Reject
        </a>

        <a class="btn btn-warning" href="{{ route('increase_client_status1' , $dataTypeContent->id) }}">
