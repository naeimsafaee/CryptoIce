    ...
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="border-item">
                ...
                <div class="line"></div>
                <a href="{{ route('dashboard') }}" class=" border-item-details flex-box @if(url()->current() == route('dashboard')) active @endif">
                ...
                <a href="{{ route('trade' , ["trade" => 'BTC_USDT']) }}" class="border-item-details flex-box @if(url()->current() == route('trader_profile')) active @endif">
                    <svg width="18" height="16" viewBox="0 0 18 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M9 0.57666L17.6603 15.4415H0.339746L9 0.57666Z" />
                    </svg>
                    <p>
                ...
                <a href="{{ route('copy_trade.index') }}" class=" border-item-details flex-box @if(url()->current() == route('copy_trade.index')) active @endif">
                    <svg width="18" height="16" viewBox="0 0 18 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M9 0.57666L17.6603 15.4415H0.339746L9 0.57666Z" />
                    </svg>
                    <p>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="border-item">
                ...
                <a class="flex-box view-all" href="{{ route('wallet') }}">
        ...
        @if(request()->route()->uri == 'copy_trade')
            <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="border-item">
                <h5 class=" margin-top text-center">
                    {{ text('register_as_trader') }}
                </h5>
                <a href="{{ route('request.index') }}" class="dark-button" style="margin: 20px; display: block;">
                    {{ text('register') }}
                </a>
