        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="form-group">
                <div class="login-blur1">
                    <img class="star1" src="assets/icon/star.svg">
                    <img class="star2" src="assets/icon/star.svg">
                    <div class="pink">
                ...
                <div class="form-list position-relative">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade @if(!old('is_number') || old('is_number') === 0) show active @endif"
                            ...
                            <form class="form-list" action="{{ route('login') }}" method="POST">
                                @csrf
                                        ...
                                        <div class=" col-lg-4 col-md-4 col-sm-4 col-5">
                                            <div class="inter-code drop-down">
                                                ...
                                                <div class="selected">
                                                    ...
                                                    <input value="+98" name="country_code"
                                                           class="selected select-input"/>
                                                </div>
                                                <div class="options">
                                                    <ul>
